...
import com.fawry.promoLoyalty.angularAutomation.backendServices.ServicesDelegate;
import com.fawry.promoLoyalty.angularAutomation.dataModels.LoginDM;
import com.fawry.promoLoyalty.angularAutomation.dataModels.MainDataModel;
...
import com.fawry.promoLoyalty.angularAutomation.utils.ServerLog;
...
public class BaseTest {
	...
	public void loginSuccessfully(String partnerType)
	{
		...
		/*switch(partnerType)
		{
			case(GeneralConstants.PARTNER_TYPE_BANK):
				vaildUserMail = generalCofigsProps.getProperty(GeneralConstants.VALID_BANK_PARTNER_MAIL);
				vaildUserPassword = generalCofigsProps.getProperty(GeneralConstants.VALID_BANK_PARTNER_PASSWORD);
				break;
			case(GeneralConstants.PARTNER_TYPE_REGULAR):
				vaildUserMail = generalCofigsProps.getProperty(GeneralConstants.VALID_REG_PARTNER_MAIL);
				vaildUserPassword = generalCofigsProps.getProperty(GeneralConstants.VALID_REG_PARTNER_PASSWORD);
				break;
		}*/
		...
		{
			Log.fatal("Could not login to promo using the supplied credentials username: " + vaildUserMail + " and password: " + vaildUserPassword);
			closeDriver();
			endReport();
			System.exit(1);
		}
	...
	{
		String recipient = generalCofigsProps.getProperty(GeneralConstants.TEST_REPORT_MAIL_RECEIPIENTS);
